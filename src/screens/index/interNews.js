...
import { FacebookAds, AdMobBanner, LinearGradient } from "expo";
...
export default class InterNews extends Component {
  ...
  getSlideshow() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=8&silder=true&limit=5')
  ...
  getNews() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=8&limit=6')
      .then(response => response.json())
      .then((response) => {
  ...
  getNews2() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=8')
      .then(response => response.json())
      .then((response) => {
