...
export default class PolitticsNews extends Component {
  ...
  getSlideshow() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=1&silder=true&limit=5')
  ...
  getNews() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=1&limit=6')
      .then(response => response.json())
      .then((response) => {
  ...
  getNews2() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=1')
      .then(response => response.json())
      .then((response) => {
