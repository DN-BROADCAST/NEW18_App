...
export default class EnterNews extends Component {
  ...
  getSlideshow() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=16&silder=true&limit=5')
  ...
  getNews() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=16&limit=6')
      .then(response => response.json())
      .then((response) => {
  ...
  getNews2() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=16')
      .then(response => response.json())
      .then((response) => {
