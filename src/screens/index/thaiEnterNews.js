...
export default class ThaiEnterNews extends Component {
  ...
  getSlideshow() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=5&silder=true&limit=5')
  ...
  getNews() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=5&limit=6')
      .then(response => response.json())
      .then((response) => {
  ...
  getNews2() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=5')
      .then(response => response.json())
      .then((response) => {
