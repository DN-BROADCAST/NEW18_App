...
export default class CrimeNews extends Component {
  ...
  getSlideshow() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=3&silder=true&limit=5')
  ...
  getNews() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=3&limit=6')
      .then(response => response.json())
      .then((response) => {
  ...
  getNews2() {
    return fetch('http://newtv.co.th/api/getNewsForMobile.php?cat=3')
      .then(response => response.json())
      .then((response) => {
